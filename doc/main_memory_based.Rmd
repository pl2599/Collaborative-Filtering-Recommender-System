...
```{r}
movie_sigs = get_significance(movie_UI,100)
save(movie_sigs,file="../output/movie_sigs.RData")

MS_sigs = get_significance(MS_UI,10)
...
```{r}
MS_sim_sig_weighted = MS_sim_pearson * MS_sigs
movie_sim_sig_weighted = movie_sim_pearson * movie_sigs
save(MS_sim_sig_weighted,file="MS_sim_sig_weighted.RData")
save(movie_sim_sig_weighted,file="movie_sim_sig_weighted.RData")


MS_pred_sig_weighted <- pred_matrix(MS_UI, MS_sim_sig_weighted)
save(MS_pred_sig_weighted, file = "MS_pred_sig_weighted.RData")

movie_pred_sig_weighted <- pred_matrix(movie_UI, movie_sim_sig_weighted)
save(movie_pred_sig_weighted, file = "movie_pred_sig_weighted.RData")
```
...
```{r}
MS_acc_sig_weighted <- test_acc_MS(MS_pred_sig_weighted, MS_UI_test)
movie_acc_sig_weighted <- test_acc_movie(movie_pred_sig_weighted, movie_UI_test)
```

### Variance Weighting + Pearson

```{r}
MS_acc_var_weighted <- test_acc_MS(MS_pred_var_weighted, MS_UI_test)
movie_acc_var_weighted <- test_acc_movie(movie_pred_var_weighted, movie_UI_test)
```
